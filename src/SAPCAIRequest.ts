...
export interface NLP {
    uuid?: string;
    intents?: Intent[];
    entities?: { [key: string]: any }; // eslint-disable-line
    language?: string;
...
export interface Conversation {
    id?: string;
    language?: string;
    memory?: { [key: string]: any }; // eslint-disable-line
    skill?: string;
...
export class SAPCAIRequest implements JovoRequest {
    ...
    getAlexaDevice(): string {
        let device = 'SAPCAI Web - voice only'; // eslint-disable-line
        return device;
    }

    getScreenResolution(): string | undefined {
        //TODO
        let resolution; // eslint-disable-line
        return resolution;
    }
    ...
    getInputValue( input: any, type: string ): any { // eslint-disable-line
        let ret : any = {}; // eslint-disable-line
        ret.gold = true;
    ...
    getMemoryInputMeta(memoryInput: any, entities: { [key:string]:any[] } ): any { // eslint-disable-line
        let meta = null;
